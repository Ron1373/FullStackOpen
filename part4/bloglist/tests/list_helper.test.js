...
describe("total likes", () => {
  ...
  test("when the list includes many blogs, equals the sum of likes of those", () => {
    assert.strictEqual(listHelper.totalLikes(blogs), 36);
  });

  test("when the list includes no blogs, equals 0", () => {
...
describe("favorite blog", () => {
  ...
  test("when the list includes more than one blog, returns the most liked blog", () => {
  ...
  test("when the list is empty, equals empty object", () => {
